...
;; Guix Label Demo
;; Demonstrates the usage and features of Guix label components
;; Supports different font sizes, weights, colors, and themes
...
(new message% 
     [parent main-panel]
     [label "3. Font Weights"]
     [font (send the-font-list find-or-create-font 14 'default 'normal 'bold)])

(define weights-panel
  (new vertical-panel% 
       [parent main-panel]
       [alignment '(center center)]
       [spacing 10]))
...
(new label% 
     [parent colors-panel]
     [label "Green Text"]
     [color (make-object color% 0 255 0)])
...
(new label% 
     [parent colors-panel]
     [label "Yellow Text"]
     [color (make-object color% 255 255 0)])

(new label% 
     [parent colors-panel]
     [label "Purple Text"]
     [color (make-object color% 128 0 128)])

;; Section 5: Enabled/Disabled States
(new message% 
     [parent main-panel]
     [label "5. Enabled/Disabled States"]
     [font (send the-font-list find-or-create-font 14 'default 'normal 'bold)])
...
(new label% 
     [parent enable-panel]
     [label "Disabled Custom Color Label"]
     [enabled? #f]
     [color (make-object color% 255 0 0)])
...
(new label% 
     [parent theme-panel]
     [label "Theme Demo Label 1"]
     [font-size 'regular]
     [font-weight 'normal])

(new label% 
     [parent theme-panel]
     [label "Theme Demo Label 2"]
     [font-size 'medium]
     [font-weight 'bold])

(new label% 
     [parent theme-panel]
     [label "Theme Demo Label 3"]
     [font-size 'large]
     [font-weight 'normal])
